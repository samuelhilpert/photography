    ...
    <div class="container mx-auto flex flex-row justify-content: center gap-4 pt-4">
        <div class="flex-1 border rounded-lg shadow-md bg-text ">
            ...
            <div class="ml-5 mr-5 mt-10">
                ...
                <br>
                <h2 class="font-bold">Datenerfassung auf dieser Website</h2>
                <h3 class="font-medium">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h3>
                <p>Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten
                    können Sie dem Abschnitt „Hinweis zur Verantwortlichen Stelle“ in dieser Datenschutzerklärung
                    entnehmen.</p>
                <br>
                <h3 class="font-medium">Wie erfassen wir Ihre Daten?</h3>
                ...
                <p>Andere Daten werden automatisch oder nach Ihrer Einwilligung beim Besuch der Website durch unsere IT-
                    Systeme erfasst. Das sind vor allem technische Daten (z. B. Internetbrowser, Betriebssystem oder
                    Uhrzeit des Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald Sie diese Website
                    betreten.</p>
                <br>
                <h3 class="font-medium">Wofür nutzen wir Ihre Daten?</h3>
                ...
                <br>
                <h1 class="text-lg font-bold">2. Hosting</h1>
                <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
                <h2 class="font-bold">Externes Hosting</h2>
                ...
                <p>Wir setzen folgende(n) Hoster ein:</p><br>
                ...
                <br>
                <h2 class="font-bold">Speicherdauer</h2>
                ...
                <br>
                <h2 class="font-bold">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser
                    Website</h2>
                ...
                <br>
                <h2 class="font-bold">Empfänger von personenbezogenen Daten</h2>
                ...
                <br>
                <h2 class="font-bold">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h2>
                ...
                <br>
                <h2 class="font-bold">Recht auf Datenübertragbarkeit</h2>
                ...
                <br>
                <h2 class="font-bold">Auskunft, Berichtigung und Löschung</h2>
                ...
                <br>
                <h2 class="font-bold">Recht auf Einschränkung der Verarbeitung</h2>
                ...
                <p>Wenn die Verarbeitung Ihrer personenbezogenen Daten unrechtmäßig geschah/geschieht, können Sie statt
                    der Löschung die Einschränkung der Datenverarbeitung verlangen.</p>
                <p>Wenn wir Ihre personenbezogenen Daten nicht mehr benötigen, Sie sie jedoch zur Ausübung, Verteidigung
                ...
                <br>
                <h2 class="font-bold">SSL- bzw. TLS-Verschlüsselung</h2>
                ...
                <br>
                <h1 class="font-bold text-lg">4. Datenerfassung auf dieser Website</h1>
                <h2 class="font-bold">Kontaktformular</h2>
                ...
                <br>
                <h2 class="font-bold">Anfrage per E-Mail, Telefon oder Telefax</h2>
                ...
                <br>
                <h1 class="font-bold text-lg">5. Soziale Medien</h1>
                <h2 class="font-bold">Instagram</h2>
                ...
                <p>Soweit mit Hilfe des hier beschriebenen Tools personenbezogene Daten auf unserer Website erfasst und
                    ...
                    ausschließlich auf die Erfassung der Daten und deren Weitergabe an Facebook bzw. Instagram. Die nach
                    ...
                    unter: https://www.facebook.com/legal/controller_addendum. Laut dieser Vereinbarung sind wir für die
                    Erteilung der Datenschutzinformationen beim Einsatz des Facebook- bzw. Instagram-Tools und für die
                    ...
                    Betroffenenrechte</p>
                <p>(z. B. Auskunftsersuchen) hinsichtlich der bei Facebook bzw. Instagram verarbeiteten Daten können Sie
                ...
                <p>https://www.facebook.com/legal/EU_data_transfer_addendum, https://privacycenter.instagram.com/policy/
                    und https://de-de.facebook.com/help/566994660333381.</p>
                <p>Weitere Informationen hierzu finden Sie in der Datenschutzerklärung von Instagram:
                    https://privacycenter.instagram.com/policy/.Das Unternehmen verfügt über eine Zertifizierung nach
                    dem „EU-US Data Privacy Framework“ (DPF). Der DPF ist ein Übereinkommen zwischen der Europäischen
                    Union und den USA, der die Einhaltung europäischer Datenschutzstandards bei Datenverarbeitungen in
                    den USA gewährleisten soll. Jedes nach dem DPF zertifizierte Unternehmen verpflichtet sich, diese
