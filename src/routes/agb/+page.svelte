    ...
    <div class="container mx-auto flex flex-row justify-content: center gap-4 pt-4">
        <div class="flex-1 border rounded-lg shadow-md bg-text ">
            ...
            <div class="ml-5 mr-5 mt-10">
                Allgemeine Geschäftsbedingungen der Firma SaSv Photography<br />
                <br />
                <p class="font-bold text-xl">Geltung <p/>
                <br />
                ...
                <br />
                <br />
                <p class="font-bold text-xl">Zustandekommen des Vertrages</p>
                <br />
                <p style="font-weight: bold; padding-bottom: 10px;">§2 Zustandekommen eines Vertrages, Speicherung des Vertragstextes</p>
                (1) Die folgenden Regelungen über den Vertragsabschluss gelten für Bestellungen über unseren Internetshop http://sasvphotography.de .<br />
                <br />
                ...
                E-Mail zu. Die AGB können Sie jederzeit auch unter http://sasvphotographymuster.de/agb.html  einsehen.

                Ihre Bestelldaten sind aus Sicherheitsgründen nicht mehr über das Internet zugänglich.
                <br />

                <br />
                <p class="font-bold text-xl">Preise/Kosten</p>
                <br />
              ...
              <p class="font-bold text-xl">Lieferung</p>
                <br />
                <p style="font-weight: bold; padding-bottom: 10px;">§4 Lieferung</p>
                (1) Sofern wir dies in der Produktbeschreibung nicht deutlich anders angegeben haben, sind alle von uns angebotenen Artikel sofort versandfertig.
                Die Lieferung erfolgt hier spätesten innerhalb von 365 Werktagen.
                ...
                <p class="font-bold text-xl">Eigentumsvorbehalt</p>
                <br />
                ...
                <br />
                <p class="font-bold text-xl">Widerrufsrecht</p>
                ...
                ****************************************************************************************************
                ...
                <div style="margin-left:20px; margin-top: 5px; margin-bottom: 5px;">
                    ...
                    Coblitzalle 1-9<br />
                    D-68163 Mannheim<br />
                    E-Mail samuelhilpert@web.de<br />
                </div>
                ...
                ****************************************************************************************************
                ...
                <br />
               <p class="font-bold text-xl">Sprache</p>
                <br />
